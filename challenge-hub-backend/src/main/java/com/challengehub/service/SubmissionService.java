...
public interface SubmissionService {
    ...
    SubmissionCreateResponse submitTask(String taskId, CreateSubmissionRequest request, String currentUserId);

    SubmissionResponse resubmit(String submissionId, CreateSubmissionRequest request, String currentUserId);

    SubmissionResponse updateSubmissionStatus(String submissionId, UpdateSubmissionStatusRequest request,
    ...
    PageResult<SubmissionResponse> getMySubmissions(String currentUserId, String challengeId, String status, int page,
            int size);

    PageResult<SubmissionResponse> getPendingSubmissions(String currentUserRole, String challengeId, int page,
            int size);
