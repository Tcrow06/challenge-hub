...
public class SubmissionController {
    ...
    public ResponseEntity<ApiResponse<SubmissionResponse>> submitTask(
        ...
        SubmissionResponse response = submissionService.submitTask(taskId, request, currentUserId(authentication));
    ...
    public ResponseEntity<ApiResponse<SubmissionResponse>> resubmit(
        ...
        SubmissionResponse response = submissionService.resubmit(submissionId, request, currentUserId(authentication));
