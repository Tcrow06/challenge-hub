...
public interface SubmissionRepository extends JpaRepository<SubmissionEntity, UUID> {
    ...
    List<SubmissionEntity> findByUser_IdAndTask_Challenge_IdAndStatusOrderBySubmittedAtDesc(UUID userId, UUID challengeId, Enums.SubmissionStatus status);

    List<SubmissionEntity> findByStatusOrderBySubmittedAtAsc(Enums.SubmissionStatus status);

    List<SubmissionEntity> findByStatusAndTask_Challenge_IdOrderBySubmittedAtAsc(Enums.SubmissionStatus status, UUID challengeId);
    ...
    Page<SubmissionEntity> findByUser_IdAndTask_Challenge_IdAndStatus(UUID userId, UUID challengeId, Enums.SubmissionStatus status, Pageable pageable);

    Page<SubmissionEntity> findByStatus(Enums.SubmissionStatus status, Pageable pageable);

    Page<SubmissionEntity> findByStatusAndTask_Challenge_Id(Enums.SubmissionStatus status, UUID challengeId, Pageable pageable);
